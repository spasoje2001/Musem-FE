...
@Component({
  selector: 'app-pdf-personal-cleaning-prompt',
  templateUrl: './pdf-personal-cleaning-prompt.component.html',
  styleUrls: ['./pdf-personal-cleaning-prompt.component.css'],
  animations: [
      trigger('buttonState', [
        state('clicked', style({
          transform: 'scale(0.9)',
...
export class PdfPersonalCleaningPromptComponent {
  ...
  constructor(private cleaningService: CleaningService,
              ...
              private dialogRef: MatDialogRef<PdfPersonalCleaningPromptComponent>,
...
loadPdf(): void {
  this.cleaningService.seeGeneratedPersonalReport(this.user!.id).subscribe((pdfBlob: Blob) => {
